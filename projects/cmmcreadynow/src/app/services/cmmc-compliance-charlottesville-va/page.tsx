...
export const metadata: Metadata = {
  title: 'CMMC Compliance Services in Charlottesville, Va | CMMC Ready Now',
  description: 'Charlottesville defense contractors: Home to NGIC and defense intelligence operations. Get CMMC Level 2 compliance for intelligence contractors and research firms.',
  keywords: ['CMMC compliance Charlottesville', 'CMMC Charlottesville Va', 'CMMC Level 2 Charlottesville', 'DFARS compliance Charlottesville', 'defense contractor cybersecurity Charlottesville'],
  openGraph: {
    title: 'CMMC Compliance Services in Charlottesville, Va | CMMC Ready Now',
    description: 'Charlottesville defense contractors: Home to NGIC and defense intelligence operations. Get CMMC Level 2 compliance for intelligence contractors and research firms.',
    type: 'website',
...
export default function CMMCComplianceCharlottesville() {
  return (
    <>
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden bg-navy-800">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight mb-6 animate-fade-in-up">
            Charlottesville Defense Contractors:<br />
          ...
          <div className="text-lg sm:text-xl text-gray-300 mb-10 space-y-3">
            <p>Get CMMC Level 2 compliance for Charlottesville defense contractors.</p>
      ...
      <section id="free-assessment" className="py-20 lg:py-28 bg-navy-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">Speak with our Charlottesville CMMC experts. We understand local defense industry requirements.</p>
          </div>
          <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-2xl">
            <iframe src="https://api.leadconnectorhq.com/widget/form/9qEaBzqiyyfA9Tq823ks" style={{ width: '100%', border: 'none', overflow: 'hidden' }} scrolling="no" id="inline-9qEaBzqiyyfA9Tq823ks" data-form-name="CMMC Charlottesville Consultation" className="w-full min-h-[600px]" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="font-bold text-navy-800 mb-3">Serving Charlottesville & Region</h3>
              <p className="text-gray-600 text-sm leading-relaxed">Charlottesville area defense contractors and suppliers. We provide on site and remote CMMC compliance support.</p>
            </div>
            <div>
