...
export const metadata: Metadata = {
  title: 'CMMC Compliance Services in Washington, DC | CMMC Ready Now',
  description: 'Washington DC defense contractors: Federal epicenter. Government relations, policy support, and consulting firms at the heart of defense decision making.',
  keywords: ['CMMC compliance Washington DC', 'federal contractor cybersecurity', 'DC defense consultant CMMC', 'government relations CMMC'],
  openGraph: { title: 'CMMC Compliance in Washington, DC | Federal Epicenter Ready', type: 'website' },
};

export default function CMMCComplianceWashingtonDC() {
  return (
    <>
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden bg-navy-800">
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight mb-6">
            Washington DC Federal Contractors:<br /><span className="text-accent">Policy Meets Security</span>
          </h1>
          <div className="text-lg sm:text-xl text-gray-300 mb-10 space-y-3">
            <p>Washington DC is where defense policy becomes reality.</p>
            <p>Your consulting and policy work shapes the future of national security operations.</p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div><h3 className="font-bold text-navy-800 mb-3">Serving Washington DC Federal Contractors</h3></div>
            <div>
