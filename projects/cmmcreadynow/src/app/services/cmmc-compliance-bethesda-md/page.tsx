...
export const metadata: Metadata = {
  title: 'CMMC Compliance Services in Bethesda, Maryland | CMMC Ready Now',
  description: 'Bethesda defense contractors: NIH and defense medical hub. Biodefense, medical research, and health technology contractors serving DoD health missions.',
  keywords: ['CMMC compliance Bethesda MD', 'biodefense contractor cybersecurity', 'NIH contractor CMMC', 'medical research cybersecurity'],
  openGraph: { title: 'CMMC Compliance in Bethesda, MD | Medical & Biodefense Ready', type: 'website' },
};

export default function CMMCComplianceBethesdaMD() {
  return (
    <>
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden bg-navy-800">
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight mb-6">
            Bethesda Medical Defense:<br /><span className="text-accent">Protect Health, Secure Data</span>
          </h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div><h3 className="font-bold text-navy-800 mb-3">Serving Bethesda Medical Defense</h3></div>
            <div>
            ...
            <div><p className="text-gray-600 text-sm">CMMC Ready Now is powered by <a href="https://capital-cyber.com/cmmc-compliance-services/?utm_source=online&utm_medium=website&utm_campaign=cmmcreadynow&utm_content=locationpage" className="font-bold text-navy-800">Capital Cyber</a>.</p></div>
          </div>
        </div>
      </section>
