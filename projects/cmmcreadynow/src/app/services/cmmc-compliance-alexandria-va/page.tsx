...
export const metadata: Metadata = {
  title: 'CMMC Compliance Services in Alexandria, Virginia | CMMC Ready Now',
  description: 'Alexandria defense contractors: DoD proximity advantage. Professional services, consulting, and technology firms minutes from Pentagon operations.',
  keywords: ['CMMC compliance Alexandria VA', 'DoD proximity contractors', 'Alexandria cybersecurity services', 'Pentagon area CMMC'],
  openGraph: { title: 'CMMC Compliance in Alexandria, VA | DoD Proximity Ready', type: 'website' },
};

export default function CMMCComplianceAlexandriaVA() {
  return (
    <>
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden bg-navy-800">
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight mb-6">
            Alexandria DoD Contractors:<br /><span className="text-accent">Pentagon Proximity Advantage</span>
          </h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div><h3 className="font-bold text-navy-800 mb-3">Serving Alexandria DoD Contractors</h3></div>
            <div>
