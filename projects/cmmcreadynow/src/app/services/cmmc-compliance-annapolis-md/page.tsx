...
export const metadata: Metadata = {
  title: 'CMMC Compliance Services in Annapolis, Md | CMMC Ready Now',
  description: 'Annapolis defense contractors: Naval Academy and maritime defense community. Get CMMC Level 2 compliance for naval education and maritime contractors.',
  keywords: ['CMMC compliance Annapolis', 'CMMC Annapolis Md', 'CMMC Level 2 Annapolis', 'DFARS compliance Annapolis', 'defense contractor cybersecurity Annapolis'],
  openGraph: {
    title: 'CMMC Compliance Services in Annapolis, Md | CMMC Ready Now',
    description: 'Annapolis defense contractors: Naval Academy and maritime defense community. Get CMMC Level 2 compliance for naval education and maritime contractors.',
    type: 'website',
...
export default function CMMCComplianceAnnapolis() {
  return (
    <>
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden bg-navy-800">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight mb-6 animate-fade-in-up">
            Annapolis Defense Contractors:<br />
          ...
          <div className="text-lg sm:text-xl text-gray-300 mb-10 space-y-3">
            <p>Get CMMC Level 2 compliance for Annapolis defense contractors.</p>
      ...
      <section id="free-assessment" className="py-20 lg:py-28 bg-navy-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">Speak with our Annapolis CMMC experts. We understand local defense industry requirements.</p>
          </div>
          <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-2xl">
            <iframe src="https://api.leadconnectorhq.com/widget/form/9qEaBzqiyyfA9Tq823ks" style={{ width: '100%', border: 'none', overflow: 'hidden' }} scrolling="no" id="inline-9qEaBzqiyyfA9Tq823ks" data-form-name="CMMC Annapolis Consultation" className="w-full min-h-[600px]" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="font-bold text-navy-800 mb-3">Serving Annapolis & Region</h3>
              <p className="text-gray-600 text-sm leading-relaxed">Annapolis area defense contractors and suppliers. We provide on site and remote CMMC compliance support.</p>
            </div>
            <div>
